(function () {
    ...
    // 设置仪表盘密钥：优先使用 config.js 中配置的 __DASHBOARD_KEY__，否则从 localStorage 读取
    window.dashboardKey = (function(){
        if (typeof window.__DASHBOARD_KEY__ === 'string') return window.__DASHBOARD_KEY__;
        try { return localStorage.getItem('dashboard_key') || ''; } catch(e) { return ''; }
    })();
    // 立即解锁
    window.dispatchEvent(new Event('auth-ready'));
    return;
})();
// Original authBootstrap code preserved below (unreachable due to return above)
(function _orig() {
